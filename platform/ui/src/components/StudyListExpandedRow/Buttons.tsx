    ...
    <div className="w-full bg-black py-4 pl-12 pr-2">
      <div className="sharebutton">
        <button
          ...
          className="hover:bg-primary-main bg-secondary-main ml-2 rounded-lg px-4 py-2 text-white hover:border-[#4E9F3D]"
        ...
        <tr>
          ...
          <td colSpan={2}>
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-600 bg-opacity-50">
              <div className="bg-secondary-main mx-4 w-full max-w-sm rounded p-4 shadow-lg">
                ...
                >
                  ...
                  <div className="flex justify-between">
                    ...
                    <button
                      className="bg-secondary-main rounded px-3 py-2 text-white"
                      type="submit"
                    >
                      Submit
                    </button>
