...
const enabledEffectClasses = {
  [ButtonEnums.type.primary]: classnames(
    ...
    'hover:bg-primary-main/80 active:bg-primary-main/40' // Using bg-primary-main
  ),
  [ButtonEnums.type.secondary]: classnames(
    baseEnabledEffectClasses,
    'hover:bg-secondary-main/80 active:bg-secondary-main/40' // Using bg-secondary-main
  ),
};
...
const enabledClasses = {
  [ButtonEnums.type.primary]: classnames(
    'bg-primary-main', // Primary green color
    baseEnabledClasses,
    enabledEffectClasses[ButtonEnums.type.primary]
  ),
  [ButtonEnums.type.secondary]: classnames(
    'bg-secondary-main', // Secondary green color
    baseEnabledClasses,
